      ...
      {stage === 'intro' ? (
          ...
          <div className="flex flex-col items-center my-auto space-y-5">
            ...
            <div className="space-y-1.5 max-w-xs">
              ...
              <p className="text-[10px] text-blue-200/80 leading-relaxed font-medium">
                Waste Integrated Sanitation Ecosystem
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 w-full flex flex-col justify-between items-center py-3 animate-in fade-in duration-500">
          ...
          <div className="w-full pt-2 flex flex-col items-center">
            <div className="w-16 h-16 rounded-2xl bg-white text-municipal-blue font-black flex flex-col items-center justify-center shadow-xl border-2 border-white/40 mb-2">
              <span className="text-xl leading-none">IMC</span>
              <span className="text-[8px] tracking-widest text-slate-600 font-bold uppercase">Indore</span>
            </div>
