...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-30 bg-gradient-to-r from-blue-700 via-blue-600 to-blue-800 text-white px-3 py-2 shadow-md flex items-center justify-between gap-2 border-b border-blue-900/60" style={{minHeight: '48px'}}>
      {/* Left: IMC Logo + Ward Selector */}
      <div className="flex items-center gap-2 min-w-0">
        {/* IMC Logo Badge */}
        <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center shrink-0 shadow-sm border border-white/40">
          <img src="/imc_logo.png" alt="IMC" className="w-7 h-7 object-contain rounded-full" />
        </div>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1 bg-white/15 hover:bg-white/25 active:bg-white/30 text-white rounded-full px-2.5 py-1.5 min-h-touch text-xs font-medium border border-white/20 shadow-sm transition"
          >
